...
export default async function handler(req, res) {
    ...
    if (req.body.task === 'generate_content') {
        ...
        const videoURL = 'https://bootcamp-rks.s3.ap-south-1.amazonaws.com/SampleVideo_1280x720_5mb.mp4'
        const thumbnailURL = 'https://bootcamp-rks.s3.ap-south-1.amazonaws.com/animals.jpeg'
